...
":split-equalities"          { return TK_SPLITEQUALITIES; }
...
"!"                          { return TK_ANNOT; }
"assert-partition"           { return TK_ASSERT_PARTITION; }
