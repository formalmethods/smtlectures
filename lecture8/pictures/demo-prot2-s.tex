...
\pgfrealjobname{demo-prot2-s}

\begin{document}

\beginpgfgraphicnamed{demo-prot2-s-fig}
\begin{tikzpicture}
 ...
 \path (i) edge [arrow] node [right] {\tt t1} (w);
 \path (w) edge [arrow] node [right] {\tt t2} (c);
 \path (c) edge [arrow] node [right] {\tt t3} (e);
 \path (e) edge [arrow, bend left] node [left] {\tt t4} (i);
\end{tikzpicture}
\endpgfgraphicnamed
